mkdir input
cp -f ../projects/target_apps/ble_examples/ble_app_peripheral/Keil_5/out_580/ble_app_peripheral_580.hex input/fw_1.hex
cp -f ../projects/target_apps/ble_examples/ble_app_peripheral/Keil_5/out_580/ble_app_peripheral_580.hex input/fw_2.hex
