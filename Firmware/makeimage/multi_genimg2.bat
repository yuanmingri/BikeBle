mkdir input
cp -f ../projects/target_apps/peripheral_examples/blinky/Keil_5/out/blinky.hex input/fw_1.hex
cp -f ../projects/target_apps/peripheral_examples/blinky/Keil_5/out/blinky.hex input/fw_2.hex
